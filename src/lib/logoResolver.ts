...
export const BANK_LOGOS: { key: string; source: ReturnType<typeof require>; name: string }[] = [
  { key: "bank/bdo.png", source: BANK_LOGO_MAP["bank/bdo.png"]!, name: "BDO" },
  { key: "bank/bpi.png", source: BANK_LOGO_MAP["bank/bpi.png"]!, name: "BPI" },
  { key: "bank/chinabank.png", source: BANK_LOGO_MAP["bank/chinabank.png"]!, name: "Chinabank" },
  { key: "bank/gcash.png", source: BANK_LOGO_MAP["bank/gcash.png"]!, name: "GCash" },
  { key: "bank/gotyme.png", source: BANK_LOGO_MAP["bank/gotyme.png"]!, name: "GoTyme" },
  { key: "bank/maribank.png", source: BANK_LOGO_MAP["bank/maribank.png"]!, name: "MariBank" },
  { key: "bank/maya.png", source: BANK_LOGO_MAP["bank/maya.png"]!, name: "Maya" },
  { key: "bank/metrobank.png", source: BANK_LOGO_MAP["bank/metrobank.png"]!, name: "Metrobank" },
  { key: "bank/pagibig.png", source: BANK_LOGO_MAP["bank/pagibig.png"]!, name: "PAG-IBIG" },
  { key: "bank/pnb.png", source: BANK_LOGO_MAP["bank/pnb.png"]!, name: "PNB" },
  { key: "bank/unionbank.png", source: BANK_LOGO_MAP["bank/unionbank.png"]!, name: "UnionBank" },
  { key: "bank/vybebpi.png", source: BANK_LOGO_MAP["bank/vybebpi.png"]!, name: "Vybe by BPI" },
];
