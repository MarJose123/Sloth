...
export function EmptyAccountsCard({
  ...
  return (
    <View className="mt-6 items-center rounded-2xl border border-dashed border-white/20 px-6 py-10">
      <Text className="mb-2 text-center font-fraunces-medium text-[22px] text-parchment">
        No accounts yet
      </Text>
      <Text className="mb-6 text-center text-[14.5px] leading-[21px] text-parchment-dim">
