...
export function EmptyAccountsCard({
  ...
  return (
    <View className="mt-6 items-center rounded-2xl border border-hairline bg-surface-card px-6 py-10">
      <Text className="mb-2 text-center font-fraunces-medium text-[22px] text-text-primary">
        No accounts yet
      </Text>
      <Text className="mb-6 text-center text-[14.5px] leading-[21px] text-text-secondary">
